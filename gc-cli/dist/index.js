...
function createOptionsObject(_ref) {
	...
	optionsObject.libraryIdentifiersToRequire = new Map([[List.of("caplin"), "caplin-bootstrap"], [List.of("emitr"), "emitr"], [List.of("jQuery"), "jquery"], [List.of("sinon"), "sinonjs"], [List.of("queryString"), "query-string"], [List.of("JsMockito"), "jsmockito"], [List.of("JsHamcrest"), "jshamcrest"], [List.of("Mock4JS"), "mock4js"], [List.of("moment", "()", "tz"), "moment-timezone"]]);
