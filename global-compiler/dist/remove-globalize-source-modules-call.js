import { callExpressionMatcher, composeMatchers, identifierMatcher } from "./utils/matchers";
import { nodePathLocatorVisitor } from "./node-path-locator";

const globalizeSourceModulesCallMatcher = composeMatchers(identifierMatcher('globalizeSourceModules'), callExpressionMatcher({ callee: identifierMatcher('globalizeSourceModules') }));
